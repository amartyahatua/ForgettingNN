...
(x_train, y_train), (x_test, y_test), min_pixel_value, max_pixel_value = load_mnist_digit()
...
df_accuracy.to_csv('mnist/result/digit/Baseline_accuracy.csv', index=False)
mia_score_df.to_csv('mnist/result/digit/Baseline_mia.csv', index=False)
